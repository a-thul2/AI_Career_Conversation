...
class Me:
    ...
    def __init__(self):
        ...
        reader = PdfReader("me/Resume_Software_Developer.pdf")
        self.resume = ""
        for page in reader.pages:
            text = page.extract_text()
            if text:
...
If the user is engaging in discussion, try to steer them towards getting in touch via email; ask for their email and record it using your record_user_details tool. "
        ...
        system_prompt += f"\n\n## Summary:\n{self.summary}\n\n## LinkedIn Profile:\n{self.linkedin}\n\n## Resume:\n{self.resume}\n\n"
        system_prompt += f"With this context, please chat with the user, always staying in character as {self.name}. Never say things like I am an AI and so on. Always stay in character as {self.name}. "
